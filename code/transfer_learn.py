...
if __name__ == '__main__':
    ...
    if gen_data:
        ...
        new_path = 'myo_rec_data/win_JRS_7C_2'
        ...
        WT_PATH = 'nina_data/all_7C_data_3_adamw_best'
        ...
        nt.stats['val']['model_wt'] = torch.load(WT_PATH+'.pt')
        tl,ta = nt.test(use_best_wt=True,epoch=1)


        num = model.fc3.in_features
        ft_nt = Trainer(model,optimizer,criterion,device,new_PATH,params,epochs=2000,early_stop=False)
        ft_nt.stats['val']['model_wt'] = torch.load(WT_PATH+'.pt')
        ...
        torch.save(ft_nt.stats['val']['model_wt'],new_PATH+'__adamw_best_tran1.pt')
        plot_path = 'win_JRS_7C_2_adamw_best_tran1'
